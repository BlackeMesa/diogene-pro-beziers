...
const Sitemap = () => {
  useEffect(() => {
    ...
    const urls = [
      ...
      { loc: 'https://lelienproprete34.com/nettoyage-diogene-sete', changefreq: 'monthly', priority: '0.9' },
      { loc: 'https://lelienproprete34.com/nettoyage-diogene-agde', changefreq: 'monthly', priority: '0.9' },
      { loc: 'https://lelienproprete34.com/nettoyage-diogene-lunel', changefreq: 'monthly', priority: '0.9' },
      { loc: 'https://lelienproprete34.com/nettoyage-diogene-frontignan', changefreq: 'monthly', priority: '0.9' },
      { loc: 'https://lelienproprete34.com/nettoyage-diogene-pezenas', changefreq: 'monthly', priority: '0.9' },
      { loc: 'https://lelienproprete34.com/nettoyage-diogene-meze', changefreq: 'monthly', priority: '0.9' },
      { loc: 'https://lelienproprete34.com/nettoyage-diogene-marseillan', changefreq: 'monthly', priority: '0.9' },
      { loc: 'https://lelienproprete34.com/nettoyage-diogene-balaruc-les-bains', changefreq: 'monthly', priority: '0.9' },
