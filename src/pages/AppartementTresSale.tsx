...
// Images humaines
import technicienParquet from "@/assets/image/homme_nettoyant_parquet.jpg";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24">
        <div className="container mx-auto px-4 py-12">
          <BreadcrumbNav items={[{ label: "Appartement Très Sale - Que Faire ?" }]} />
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6">
                  Votre appartement est très sale ?<br />
                  Voici la solution
                </h1>
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  Vous n'êtes pas seul(e) face à cette situation. Nous sommes là pour vous aider à retrouver un espace de vie sain, avec humanité et sans aucun jugement.
                </p>
              ...
              <div>
                <img src={technicienParquet} alt="Technicien nettoyant un parquet lors d'une intervention" className="rounded-2xl shadow-strong w-full object-cover h-80" loading="lazy" />
              </div>
            </div>
          </section>
          ...
          <section className="py-16 bg-secondary rounded-2xl px-8 mb-16">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold text-primary mb-6">Vous n'êtes pas seul(e)</h2>
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Beaucoup de personnes se retrouvent dans cette situation : maladie, dépression, perte d'un proche, surmenage... Les raisons sont multiples et nous les comprenons.
              </p>
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                <strong className="text-card-foreground">Ce n'est pas une question de volonté.</strong> C'est une situation qui peut arriver à chacun, et il existe des solutions pour s'en sortir avec dignité.
              </p>
          ...
          {/* Checklist Signes */}
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-primary mb-8 text-center">Signes qu'il faut faire appel à un professionnel</h2>
            <div className="max-w-3xl mx-auto bg-card rounded-2xl p-8 shadow-medium">
              <p className="text-muted-foreground mb-6">Si vous reconnaissez plusieurs de ces situations, il est temps d'agir :</p>
              ...
              <div className="mt-8 p-4 bg-accent/10 rounded-xl border border-accent">
                <p className="text-sm text-card-foreground text-center">
                  <strong>Important :</strong> Plus vous attendez, plus la situation se dégrade. Agir maintenant, c'est reprendre le contrôle.
                </p>
              </div>
            </div>
          </section>
          ...
          {/* Étapes Intervention */}
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-primary mb-8 text-center">Les étapes de notre intervention</h2>
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
              {etapes.map((etape, index) => (
                <div key={index} className="bg-card p-6 rounded-xl shadow-medium relative">
                  <div className="absolute -top-4 -left-4 w-12 h-12 bg-accent text-accent-foreground rounded-full flex items-center justify-center font-bold text-xl shadow-strong">{etape.numero}</div>
                  <h3 className="text-xl font-bold text-card-foreground mb-3 mt-2">{etape.titre}</h3>
          ...
          <section className="bg-gradient-hero text-primary-foreground rounded-2xl p-8 md:p-12 mb-16">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Reprenez le contrôle - appelez-nous</h2>
              <p className="text-xl mb-8 opacity-95 leading-relaxed">Chaque jour qui passe rend la situation plus difficile. Ensemble, nous pouvons retrouver un espace de vie sain et digne.</p>
              ...
              <p className="text-sm opacity-90">Disponible 7j/7 - Réponse garantie sous 2h</p>
            </div>
          </section>

          {/* FAQ */}
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-primary mb-8 text-center">Vos questions, nos réponses</h2>
            <div className="max-w-3xl mx-auto space-y-6">
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <h3 className="font-bold text-lg mb-2 text-card-foreground">C'est vraiment confidentiel ?</h3>
                <p className="text-muted-foreground">Oui, absolument. Nous intervenons en toute discrétion, sans logo apparent sur nos véhicules si vous le souhaitez. Votre situation reste strictement confidentielle.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <h3 className="font-bold text-lg mb-2 text-card-foreground">Que faire des objets de valeur ou souvenirs ?</h3>
                <p className="text-muted-foreground">Nous trions avec vous ou selon vos consignes. Les objets de valeur sont mis de côté, les souvenirs sont protégés. Vous décidez ce qui doit être conservé.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <h3 className="font-bold text-lg mb-2 text-card-foreground">Combien de temps prend l'intervention ?</h3>
                <p className="text-muted-foreground">Selon la surface et le niveau : de 1 à 5 jours en moyenne. Nous vous donnons une estimation précise lors de l'évaluation gratuite.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <h3 className="font-bold text-lg mb-2 text-card-foreground">Dois-je être présent pendant l'intervention ?</h3>
                <p className="text-muted-foreground">Pas nécessairement. Certains clients préfèrent nous confier les clés et revenir une fois terminé. D'autres veulent être présents. C'est vous qui décidez.</p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-secondary rounded-2xl p-8 text-center">
            <h2 className="text-2xl font-bold text-primary mb-6">En savoir plus</h2>
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <Link to="/nettoyage-diogene" onClick={() => trackCTAClick("service", "Protocole Diogène", "/nettoyage-diogene")}>
                <Button variant="outline">Notre protocole Diogène</Button>
              </Link>
