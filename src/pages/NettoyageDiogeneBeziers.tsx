...
const NettoyageDiogeneBeziers = () => {
  ...
  const quartiers = ["Centre-Ville", "Polygone", "La Devèze", "Capnau", "La Courondelle", "La Madeleine", "Saint-Jean-d'Aureilhan", "La Treille", "Les Montimarts"];

  const villesProches = ["Sérignan", "Valras-Plage", "Villeneuve-lès-Béziers", "Vendres", "Boujan-sur-Libron", "Sauvian", "Lieuran-lès-Béziers", "Bassan"];

  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Nettoyage Diogène Béziers 7j/7 | Lien Propreté 34</title>
        <meta name="description" content="Nettoyage syndrome de Diogène à Béziers (34). Intervention discrète sous 24h. Devis gratuit ☎️ 07 56 87 57 07" />
      ...
      <main className="pt-24">
        <div className="container mx-auto px-4 py-12">
          <BreadcrumbNav items={[{ label: "Nettoyage Diogène", path: "/nettoyage-diogene" }, { label: "Béziers" }]} />

          {/* Hero Section */}
          <section className="mb-16">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6">Nettoyage syndrome de Diogène à Béziers et alentours</h1>
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  Professionnel local basé à Béziers, nous intervenons rapidement dans toute l'agglomération pour un accompagnement humain et respectueux. Protocole certifié QUALIPROPRE 10403.
                </p>
          ...
          <section className="py-16 bg-secondary rounded-2xl px-8 mb-16">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-3xl font-bold text-primary">Tous les Quartiers de Béziers Couverts</h2>
              </div>
              <p className="text-lg text-muted-foreground mb-8">Nous intervenons dans l'ensemble des quartiers de Béziers et dans toute l'agglomération.</p>
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-primary mb-8 text-center">Pourquoi choisir un professionnel local à Béziers ?</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-card p-6 rounded-xl shadow-medium">
                ...
                <p className="text-muted-foreground">Basés à Béziers, nous pouvons intervenir le jour même en cas d'urgence. Pas de frais de déplacement supplémentaires sur l'agglomération.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                ...
                <p className="text-muted-foreground">Nous connaissons parfaitement Béziers et ses spécificités : accès, déchetteries locales, services sociaux du secteur.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                ...
                <p className="text-muted-foreground">Un interlocuteur unique de Béziers vous accompagne tout au long du processus. Disponibilité et proximité garanties.</p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-gradient-hero text-primary-foreground rounded-2xl p-8 md:p-12 mb-16">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold mb-6">Délais d'intervention à Béziers</h2>
          ...
          {/* FAQ */}
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-primary mb-8 text-center">Questions fréquentes - Béziers</h2>
            <div className="max-w-3xl mx-auto space-y-6">
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <h3 className="font-bold text-lg mb-2 text-card-foreground">Intervenez-vous dans tous les quartiers de Béziers ?</h3>
                <p className="text-muted-foreground">Oui, nous couvrons l'intégralité de Béziers : centre-ville, Polygone, La Devèze, et tous les autres quartiers, sans exception ni supplément tarifaire.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <h3 className="font-bold text-lg mb-2 text-card-foreground">Quel est le délai d'intervention à Béziers ?</h3>
                <p className="text-muted-foreground">Pour une urgence, nous pouvons intervenir le jour même sur Béziers. Pour une intervention planifiée, sous 24 à 48h maximum.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <h3 className="font-bold text-lg mb-2 text-card-foreground">Y a-t-il des frais de déplacement sur Béziers ?</h3>
                <p className="text-muted-foreground">Aucun frais de déplacement sur Béziers et son agglomération proche (rayon de 15 km). Au-delà, un forfait modéré peut s'appliquer selon la distance.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <h3 className="font-bold text-lg mb-2 text-card-foreground">Comment se déroule l'évaluation à Béziers ?</h3>
                <p className="text-muted-foreground">Nous nous déplaçons gratuitement à votre domicile à Béziers pour évaluer la situation. Un devis détaillé vous est remis sous 12h.</p>
              </div>
            </div>
          </section>
