...
const NettoyageDiogeneBalaruc = () => {
  ...
  const neighborhoods = ["Centre thermal", "Les Thermes", "Port de Balaruc", "Avenue des Thermes", "Quartier des Horts", "Route de Sète", "Les Garrigues", "Bord de l'Étang"];

  const nearbyCities = ["Balaruc-le-Vieux", "Frontignan", "Sète", "Gigean", "Poussan", "Montbazin", "Bouzigues"];

  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Nettoyage Diogène Balaruc | Station Thermale - Hérault</title>
        <meta name="description" content="Nettoyage syndrome de Diogène à Balaruc-les-Bains (34540). Station thermale. Intervention rapide. Devis gratuit ☎ 07 56 87 57 07" />
      ...
      <main className="pt-24">
        <div className="container mx-auto px-4 py-12">
          <BreadcrumbNav items={[{ label: "Nettoyage Diogène", path: "/nettoyage-diogene" }, { label: "Balaruc-les-Bains" }]} />

          {/* Hero Section */}
          <section className="mb-16">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6">Nettoyage syndrome de Diogène à Balaruc-les-Bains (34540)</h1>
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  Intervention spécialisée dans la station thermale de Balaruc. Nous accompagnons les situations complexes (curistes, résidents, locataires) avec une discrétion absolue et un protocole sanitaire strict.
                </p>
              ...
              <div>
                <img src={balarucCity} alt="Vue de Balaruc-les-Bains - Intervention nettoyage Diogène" className="rounded-2xl shadow-strong w-full object-cover h-80" loading="lazy" />
              </div>
            </div>
          </section>
          ...
          <section className="py-16 bg-secondary rounded-2xl px-8 mb-16">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-3xl font-bold text-primary">Zones d'intervention à Balaruc</h2>
              </div>
              <p className="text-lg text-muted-foreground mb-8">Nous intervenons dans tous les quartiers de la station thermale et résidentielle.</p>
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-primary mb-8 text-center">Pourquoi choisir Lien Propreté à Balaruc ?</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-card p-6 rounded-xl shadow-medium">
                ...
                <p className="text-muted-foreground">Nous sommes habitués aux interventions dans les résidences de curistes et comprenons les contraintes spécifiques de la saison thermale.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                ...
                <p className="text-muted-foreground">Nous collaborons avec les services de santé et le CCAS de Balaruc pour un accompagnement global des personnes vulnérables.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                ...
                <p className="text-muted-foreground">Notre proximité nous permet d'intervenir rapidement (40-45 min) pour résoudre les situations urgentes avant l'arrivée ou le départ de locataires.</p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-gradient-hero text-primary-foreground rounded-2xl p-8 md:p-12 mb-16">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold mb-6">Délais d'intervention à Balaruc-les-Bains</h2>
          ...
          {/* FAQ */}
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-primary mb-8 text-center">Questions fréquentes - Balaruc-les-Bains</h2>
            <div className="max-w-3xl mx-auto space-y-6">
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <h3 className="font-bold text-lg mb-2 text-card-foreground">Intervenez-vous dans les résidences thermales de Balaruc ?</h3>
                <p className="text-muted-foreground">
                  Oui, nous intervenons dans tous les types d'habitations à Balaruc-les-Bains, y compris les résidences de curistes et les logements temporaires. Nous comprenons les enjeux spécifiques de cette commune
                  thermale.
                </p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <h3 className="font-bold text-lg mb-2 text-card-foreground">Quel est le délai d'intervention à Balaruc-les-Bains ?</h3>
                <p className="text-muted-foreground">Depuis Béziers, nous pouvons être à Balaruc en 40-45 minutes. Pour les interventions urgentes, nous organisons une mobilisation rapide, souvent dans la journée.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <h3 className="font-bold text-lg mb-2 text-card-foreground">Travaillez-vous avec les établissements de santé locaux ?</h3>
                <p className="text-muted-foreground">
              ...
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <h3 className="font-bold text-lg mb-2 text-card-foreground">Combien coûte un nettoyage Diogène à Balaruc-les-Bains ?</h3>
                <p className="text-muted-foreground">
          ...
          <section className="bg-secondary rounded-2xl p-8 md:p-12 text-center">
            <h2 className="text-3xl font-bold text-primary mb-4">Besoin d'aide à Balaruc-les-Bains ?</h2>
