...
import heroCleaningTeam from "@/assets/castelnaudary-city.jpg";
...
const NettoyageDiogeneCastelnaudary = () => {
  useEffect(() => {
    trackServicePageView("Nettoyage Diogène Castelnaudary");
  }, []);

  const quartiers = ["Centre-Ville", "Le Grand Bassin", "La Poste", "Les Capucins", "Villenueve"];

  const villesProches = ["Bram", "Alzonne", "Pexiora", "Villepinte", "Mas-Saintes-Puelles", "Salles-sur-l'Hers"];

  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Nettoyage Diogène Castelnaudary 7j/7 | Lien Propreté 34</title>
        <meta name="description" content="Nettoyage syndrome de Diogène à Castelnaudary (11). Intervention discrète sous 48h depuis Béziers. Devis gratuit ☎️ 07 88 43 20 55" />
        <meta property="og:title" content="Nettoyage Diogène Castelnaudary - Lien Propreté 34" />
        <meta property="og:description" content="Accompagnement professionnel et humain pour le nettoyage syndrome de Diogène à Castelnaudary et Lauragais Audois." />
        <meta property="og:url" content="https://lienproprete34.fr/nettoyage-diogene-castelnaudary" />
        <link rel="canonical" href="https://lienproprete34.fr/nettoyage-diogene-castelnaudary" />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            name: "Lien Propreté 34 - Nettoyage Diogène Castelnaudary",
            ...
            priceRange: "800€-8000€",
            areaServed: "Castelnaudary et Lauragais Audois",
      ...
      <main className="pt-24">
        <div className="container mx-auto px-4 py-12">
          <BreadcrumbNav items={[{ label: "Nettoyage Diogène", path: "/nettoyage-diogene" }, { label: "Castelnaudary" }]} />

          {/* Hero Section */}
          <section className="mb-16">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6">Nettoyage syndrome de Diogène à Castelnaudary (11)</h1>
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  Basés à Béziers (à 1h de Castelnaudary), nous intervenons dans tout le Lauragais Audois pour un accompagnement humain et respectueux. Protocole certifié QUALIPROPRE 10403.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                  <a href="tel:+33788432055" onClick={() => trackPhoneClick("castelnaudary_hero")}>
                    <Button size="lg" className="bg-gradient-cta hover:bg-accent-hover text-accent-foreground font-bold w-full sm:w-auto">
                      <Phone className="mr-2 w-5 h-5" />
                      07 88 43 20 55
                    </Button>
                  </a>
                  <Link to="/contact" onClick={() => trackCTAClick("devis", "Devis gratuit Castelnaudary", "/contact")}>
              ...
              <div>
                <img src={heroCleaningTeam} alt="Technicien Lien Propreté 34 en intervention à Castelnaudary" className="rounded-2xl shadow-strong w-full object-cover h-80" loading="lazy" />
              </div>
            </div>
          </section>
          ...
          <section className="py-16 bg-secondary rounded-2xl px-8 mb-16">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-3xl font-bold text-primary">Castelnaudary et Lauragais Audois</h2>
              </div>
              <p className="text-lg text-muted-foreground mb-8">Nous intervenons dans l'ensemble de Castelnaudary et dans tout le Lauragais Audois.</p>
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div>
                  <h3 className="font-bold text-lg mb-4 text-card-foreground">Quartiers de Castelnaudary :</h3>
                ...
                <div>
                  <h3 className="font-bold text-lg mb-4 text-card-foreground">Villes du Lauragais :</h3>
                  <div className="flex flex-wrap gap-2">
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-primary mb-8 text-center">Pourquoi nous choisir à Castelnaudary ?</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                  <Clock className="w-6 h-6 text-primary" />
                </div>
                <h3 className="text-xl font-bold mb-3 text-card-foreground">Couverture Lauragais</h3>
                <p className="text-muted-foreground">Nous intervenons dans tout le Lauragais Audois, de Castelnaudary à Bram et Alzonne.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                ...
                <p className="text-muted-foreground">Habitués aux spécificités du Lauragais : accès, infrastructures locales.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                ...
                <p className="text-muted-foreground">Véhicules banalisés, respect total de votre vie privée.</p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-gradient-hero text-primary-foreground rounded-2xl p-8 md:p-12 mb-16">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold mb-6">Délais d'intervention à Castelnaudary</h2>
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-xl p-6">
                  ...
                  <p className="text-lg">Intervention sur Castelnaudary et Lauragais</p>
                </div>
                <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-xl p-6">
              ...
              <a href="tel:+33788432055" onClick={() => trackPhoneClick("castelnaudary_delais")}>
          ...
          <section className="bg-secondary rounded-2xl p-8 md:p-12 text-center">
            <h2 className="text-3xl font-bold text-primary mb-4">Besoin d'aide à Castelnaudary ?</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a href="tel:+33788432055" onClick={() => trackPhoneClick("castelnaudary_final_cta")}>
...
export default NettoyageDiogeneCastelnaudary;
