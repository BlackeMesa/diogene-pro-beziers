            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  Conformément aux dispositions de la loi n° 2004-575 du 21 juin 2004 pour la confiance en l'économie numérique, il est précisé aux utilisateurs du site <strong>lienproprete34.fr</strong> l'identité des
                ...
                <div className="bg-secondary p-6 rounded-xl mb-4">
                  <p className="mb-2">
                    <strong>Raison sociale :</strong> Lien Propreté 34
                  </p>
                  <p className="mb-2">
                    <strong>Forme juridique :</strong> Auto-entrepreneur / Micro-entreprise
                  </p>
                  <p className="mb-2">
                    <strong>Adresse :</strong> Béziers, Hérault (34), France
                  </p>
                  <p className="mb-2">
                ...
                <p className="text-muted-foreground mb-4">Le directeur de la publication du site est le gérant de l'entreprise Lien Propreté 34.</p>
              </section>
              ...
              <section>
                ...
                <div className="bg-secondary p-6 rounded-xl mb-4">
                  ...
                  <p className="mb-2">
                    ...
                    <a href="https://ionos.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                      ionos.com
                    </a>
                  </p>
                </div>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  L'ensemble de ce site relève de la législation française et internationale sur le droit d'auteur et la propriété intellectuelle. Tous les droits de reproduction sont réservés, y compris pour les
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  Conformément au Règlement Général sur la Protection des Données (RGPD) et à la loi Informatique et Libertés, vous disposez d'un droit d'accès, de rectification, de suppression et d'opposition aux
                  données personnelles vous concernant.
                </p>
                <p className="text-muted-foreground mb-4">Pour exercer ces droits, vous pouvez nous contacter :</p>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  Ce site utilise Google Analytics pour analyser l'audience du site et améliorer son contenu. Ces cookies sont anonymisés et ne permettent pas de vous identifier personnellement.
                </p>
                <p className="text-muted-foreground mb-4">Vous pouvez désactiver ces cookies dans les paramètres de votre navigateur.</p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  Le site peut contenir des liens hypertextes vers d'autres sites. Lien Propreté 34 n'exerce aucun contrôle sur ces sites et décline toute responsabilité quant à leur contenu.
                </p>
              </section>

              <section>
                <h2 className="text-2xl font-bold text-primary mb-4">8. Droit applicable</h2>
                <p className="text-muted-foreground mb-4">Le présent site et les présentes mentions légales sont régis par le droit français. En cas de litige, les tribunaux français seront seuls compétents.</p>
              </section>
