...
const NettoyageDiogeneLunel = () => {
  ...
  const quartiers = ["Centre-ville", "Abrivados", "Mas de l'Agriculture", "ZAC Ste Marie", "Quartier de la Gare", "Route de Sommières"];

  const villesProches = ["Lunel-Viel", "Marsillargues", "Vérargues", "Saint-Just", "Saturargues", "Valergues", "Villetelle", "Saint-Nazaire-de-Pézan"];

  const faqItems = [
    {
      question: "Intervenez-vous dans le centre historique de Lunel ?",
      answer:
        "Oui, nous intervenons dans tout Lunel, y compris dans le centre ancien (l'Écusson) avec ses accès parfois difficiles. Nous disposons du matériel adapté pour évacuer les encombrants même dans les rues étroites.",
    },
    {
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24">
        <div className="container mx-auto px-4 py-12">
          <BreadcrumbNav items={[{ label: "Nettoyage Diogène", path: "/nettoyage-diogene" }, { label: "Lunel" }]} />
          ...
          <section className="py-16 bg-secondary rounded-2xl px-8 mb-16">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-3xl font-bold text-primary">Zones d'intervention à Lunel</h2>
              </div>
              <p className="text-lg text-muted-foreground mb-8">Nous couvrons l'ensemble de la commune de Lunel ainsi que les villages environnants du Pays de Lunel.</p>
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-primary mb-8 text-center">Pourquoi choisir Lien Propreté à Lunel ?</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-card p-6 rounded-xl shadow-medium">
                ...
                <p className="text-muted-foreground">Nous intervenons rapidement sur le secteur de Lunel. En cas d'urgence, notre équipe peut être sur place dans la journée.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                ...
                <p className="text-muted-foreground">Nous connaissons bien les spécificités de l'habitat lunellois, du centre ancien aux zones pavillonnaires récentes.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                ...
                <p className="text-muted-foreground">Nos interventions sont réalisées avec la plus grande discrétion, sans véhicules marqués, pour respecter votre vie privée.</p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-gradient-hero text-primary-foreground rounded-2xl p-8 md:p-12 mb-16">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold mb-6">Délais d'intervention à Lunel</h2>
          ...
          {/* FAQ */}
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-primary mb-8 text-center">Questions fréquentes - Lunel</h2>
          ...
          <section className="bg-secondary rounded-2xl p-8 md:p-12 text-center">
            <h2 className="text-3xl font-bold text-primary mb-4">Besoin d'aide à Lunel ?</h2>
