...
const NettoyageDiogeneSete = () => {
  ...
  const quartiers = ["Centre-ville", "Quartier Haut", "La Corniche", "Les Quilles", "Villeroy", "La Plagette", "Barrou", "L'Île de Thau"];

  const villesProches = ["Frontignan", "Balaruc-les-Bains", "Balaruc-le-Vieux", "Marseillan", "Mèze", "Gigean", "Poussan"];
    ...
    <>
      ...
      <main className="min-h-screen bg-background">
        <div className="container mx-auto px-4 py-12 max-w-7xl">
          <BreadcrumbNav items={[{ label: "Nettoyage Diogène", path: "/nettoyage-diogene" }, { label: "Sète" }]} />

          <section className="mb-16">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6">Nettoyage syndrome de Diogène à Sète</h1>
                <p className="text-xl text-muted-foreground mb-8">
                  Intervention professionnelle dans tout Sète et le Bassin de Thau. Nous sommes à <strong>30 minutes</strong> de Sète pour une intervention rapide et discrète.
                </p>
              ...
              <div className="relative">
                <img src={seteCity} alt="Vue de Sète et son port" className="rounded-2xl shadow-strong w-full object-cover h-80" loading="lazy" />
          ...
          <section className="mb-16 bg-secondary rounded-2xl p-8 md:p-12">
            <h2 className="text-3xl font-bold text-primary mb-6 text-center">Tous les quartiers de Sète couverts</h2>
            <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">Du port au Mont Saint-Clair, nous intervenons partout à Sète sans exception.</p>
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-primary mb-6 text-center">Bassin de Thau et communes proches</h2>
          ...
          <section className="bg-secondary rounded-2xl p-8 md:p-12 text-center">
            <h2 className="text-3xl font-bold text-primary mb-4">Besoin d'une intervention à Sète ?</h2>
            <p className="text-xl text-muted-foreground mb-8">Service rapide dans tout le Bassin de Thau</p>
