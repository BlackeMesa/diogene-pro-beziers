...
const PolitiqueConfidentialite = () => {
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Politique de Confidentialité | Le Lien Propreté 34</title>
        <meta name="description" content="Politique de confidentialité et protection des données personnelles - Le Lien Propreté 34" />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-accent/10 p-6 rounded-xl border-l-4 border-accent mb-8">
              <p className="text-muted-foreground">
                <strong>Le Lien Propreté 34</strong> s'engage à protéger votre vie privée et vos données personnelles. 
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              <section>
                ...
                <ul className="list-disc list-inside text-muted-foreground mb-4 ml-4 space-y-2">
                  ...
                  <li><strong>Contact :</strong> Téléphone, email, adresse postale</li>
                ...
                <ul className="list-disc list-inside text-muted-foreground mb-4 ml-4 space-y-2">
                  <li><strong>Données de navigation :</strong> Pages visitées, durée, clics</li>
                  <li><strong>Données techniques :</strong> Adresse IP (anonymisée), type de navigateur, appareil</li>
                  <li><strong>Cookies :</strong> Google Analytics (anonymisé)</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-4">
                  <div className="bg-card p-4 rounded-xl shadow-soft">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Établir un devis, planifier une intervention, vous contacter
                    </p>
                  </div>
                  <div className="bg-card p-4 rounded-xl shadow-soft">
                    <h4 className="font-semibold text-card-foreground mb-2">✅ Amélioration du service</h4>
                    <p className="text-sm text-muted-foreground">
                      Analyser l'utilisation du site, améliorer l'expérience utilisateur
                    </p>
                  </div>
                  <div className="bg-card p-4 rounded-xl shadow-soft">
                  ...
                  <div className="bg-card p-4 rounded-xl shadow-soft">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Facturation, comptabilité, conformité réglementaire
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-destructive/10 p-4 rounded-xl border-l-4 border-destructive">
                  <p className="text-sm text-muted-foreground flex items-start gap-2">
                    ...
                    <span>
                      <strong>Nous ne vendons JAMAIS vos données</strong> à des tiers. 
                      Nous ne les utilisons pas pour du démarchage commercial non sollicité.
                    </span>
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-muted-foreground mb-4 ml-4 space-y-2">
                  <li><strong>Chiffrement HTTPS :</strong> Toutes les communications sont sécurisées</li>
                  <li><strong>Stockage sécurisé :</strong> Données hébergées sur des serveurs sécurisés (Supabase)</li>
                  <li><strong>Accès restreint :</strong> Seules les personnes autorisées ont accès à vos données</li>
                  <li><strong>Anonymisation :</strong> Google Analytics configuré en mode anonyme</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <div className="bg-accent/10 p-6 rounded-xl border-l-4 border-accent">
                  ...
                  <ul className="list-none text-muted-foreground space-y-2">
                    <li>📧 <strong>Email :</strong> <a href="mailto:contact@lelienproprete34.com" className="text-primary hover:underline">contact@lelienproprete34.com</a></li>
                    <li>📞 <strong>Téléphone :</strong> <a href="tel:+33788432055" className="text-primary hover:underline">07 88 43 20 55</a></li>
                  </ul>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-muted-foreground mb-4 ml-4 space-y-2">
                  <li><strong>Devis non acceptés :</strong> 1 an</li>
                  <li><strong>Clients :</strong> 10 ans (obligations comptables et fiscales)</li>
                  <li><strong>Données de navigation :</strong> 25 mois (Google Analytics)</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <div className="bg-card p-4 rounded-xl shadow-soft mb-4">
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    ...
                    Les données sont anonymisées (IP masquée) et ne permettent pas de vous identifier.
                  </p>
                  <p className="text-sm text-muted-foreground">
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-muted-foreground mb-4 ml-4 space-y-2">
                  <li><strong>Prestataires techniques :</strong> Hébergement (Lovable), base de données (Supabase)</li>
                  <li><strong>Obligations légales :</strong> Autorités compétentes si requis par la loi</li>
                </ul>
                <p className="text-muted-foreground">
                  Tous nos prestataires sont conformes au RGPD et situés dans l'Union Européenne ou offrent des garanties équivalentes.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="bg-secondary p-6 rounded-xl mb-4">
                  <p className="mb-2"><strong>Le Lien Propreté 34</strong></p>
                  <p className="mb-2">📧 Email : <a href="mailto:contact@lelienproprete34.com" className="text-primary hover:underline">contact@lelienproprete34.com</a></p>
                  <p className="mb-2">📞 Téléphone : <a href="tel:+33788432055" className="text-primary hover:underline">07 88 43 20 55</a></p>
                </div>
                <p className="text-muted-foreground">
