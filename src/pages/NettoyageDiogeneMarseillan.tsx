...
const NettoyageDiogeneMarseillan = () => {
  ...
  const quartiers = ["Marseillan-Ville", "Marseillan-Plage", "Le Port", "Avenue de la Méditerranée", "Rue du Commerce", "Quartier du Castellas", "Route de Sète", "Les Onglous"];

  const villesProches = ["Agde", "Mèze", "Florensac", "Pinet", "Pomérols", "Castelnau-de-Guers", "Montagnac"];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24">
        <div className="container mx-auto px-4 py-12">
          <BreadcrumbNav items={[{ label: "Nettoyage Diogène", path: "/nettoyage-diogene" }, { label: "Marseillan" }]} />

          {/* Hero Section */}
          <section className="mb-16">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6">Nettoyage syndrome de Diogène à Marseillan (Ville et Plage)</h1>
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  Intervention professionnelle à Marseillan-Ville et Marseillan-Plage. Nous assurons le débarras et le nettoyage complet de logements insalubres, y compris en période estivale et dans les résidences
                  secondaires.
                </p>
              ...
              <div>
                <img src={marseillanCity} alt="Vue de Marseillan - Intervention nettoyage Diogène" className="rounded-2xl shadow-strong w-full object-cover h-80" loading="lazy" />
              </div>
            </div>
          </section>
          ...
          <section className="py-16 bg-secondary rounded-2xl px-8 mb-16">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-3xl font-bold text-primary">Zones d'intervention à Marseillan</h2>
              </div>
              <p className="text-lg text-muted-foreground mb-8">Nous intervenons sur l'ensemble de la commune, du centre historique jusqu'aux plages.</p>
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-primary mb-8 text-center">Pourquoi choisir Lien Propreté à Marseillan ?</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-card p-6 rounded-xl shadow-medium">
                ...
                <p className="text-muted-foreground">Nous maîtrisons les problématiques spécifiques au bord de mer (humidité, salinité) et adaptons nos protocoles de nettoyage.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                ...
                <p className="text-muted-foreground">Nous intervenons toute l'année, y compris en pleine saison touristique, pour répondre aux urgences locatives.</p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                ...
                <p className="text-muted-foreground">Basés à proximité, nous intervenons rapidement à Marseillan (30 min) sans frais de déplacement excessifs.</p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-gradient-hero text-primary-foreground rounded-2xl p-8 md:p-12 mb-16">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-bold mb-6">Délais d'intervention à Marseillan</h2>
          ...
          {/* FAQ */}
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-primary mb-8 text-center">Questions fréquentes - Marseillan</h2>
            <div className="max-w-3xl mx-auto space-y-6">
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <h3 className="font-bold text-lg mb-2 text-card-foreground">Intervenez-vous à Marseillan-Plage et Marseillan-Ville ?</h3>
              ...
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <h3 className="font-bold text-lg mb-2 text-card-foreground">Quel est le délai d'intervention à Marseillan ?</h3>
                <p className="text-muted-foreground">
              ...
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <h3 className="font-bold text-lg mb-2 text-card-foreground">Travaillez-vous en période estivale ?</h3>
                <p className="text-muted-foreground">
              ...
              <div className="bg-card p-6 rounded-xl shadow-medium">
                <h3 className="font-bold text-lg mb-2 text-card-foreground">Combien coûte un nettoyage Diogène à Marseillan ?</h3>
                <p className="text-muted-foreground">
          ...
          <section className="bg-secondary rounded-2xl p-8 md:p-12 text-center">
            <h2 className="text-3xl font-bold text-primary mb-4">Besoin d'aide à Marseillan ?</h2>
