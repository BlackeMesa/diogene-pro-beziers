  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta property="og:url" content="https://lienproprete34.fr/prix-nettoyage-diogene-guide-2026" />

        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            headline: "Prix Nettoyage Diogène 2026 : Guide Complet & Tarifs Hérault",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6">Prix Nettoyage Diogène 2026 : Guide Complet</h1>
              <p className="text-xl text-muted-foreground">Tout savoir sur les tarifs de nettoyage syndrome de Diogène dans l'Hérault : grille tarifaire, facteurs de coût, et aides financières</p>
            </div>
            ...
            <div className="bg-secondary rounded-xl p-6 mb-12">
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li>
                  •{" "}
                  <a href="#comprendre" className="hover:text-primary hover:underline">
                    Comprendre le syndrome de Diogène
                  </a>
                </li>
                <li>
                  •{" "}
                  <a href="#facteurs" className="hover:text-primary hover:underline">
                    Facteurs influençant le prix
                  </a>
                </li>
                <li>
                  •{" "}
                  <a href="#grille-tarifaire" className="hover:text-primary hover:underline">
                    Grille tarifaire détaillée 2026
                  </a>
                </li>
                <li>
                  •{" "}
                  <a href="#aides" className="hover:text-primary hover:underline">
                    Aides financières disponibles
                  </a>
                </li>
                <li>
                  •{" "}
                  <a href="#devis" className="hover:text-primary hover:underline">
            ...
            <section id="comprendre" className="mb-16">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Le syndrome de Diogène est un <strong>trouble comportemental</strong> caractérisé par une accumulation compulsive d'objets, une négligence extrême de l'hygiène personnelle et du logement, et un isolement
                social progressif. Il touche principalement les personnes âgées mais peut concerner toute personne en situation de détresse psychologique.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-6">
                Le nettoyage d'un tel logement ne peut pas être comparé à un simple ménage : il nécessite un <strong>protocole spécialisé</strong>, du matériel professionnel, et surtout une{" "}
                <strong>approche humaine et respectueuse</strong>.
              </p>
            </section>

            {/* Section 2 : Facteurs */}
            <section id="facteurs" className="mb-16">
              <h2 className="text-3xl font-bold text-primary mb-6">Les 5 facteurs qui influencent le prix</h2>
              ...
              <div className="space-y-6">
                <div className="bg-card rounded-xl p-6 shadow-medium">
                  ...
                  <p className="text-muted-foreground">
                    Plus la surface est importante, plus le temps d'intervention et la quantité de déchets à évacuer seront élevés. Un studio nécessitera 1-2 jours, tandis qu'une maison peut demander jusqu'à 7 jours de
                    travail.
                  </p>
                </div>
                ...
                <div className="bg-card rounded-xl p-6 shadow-medium">
                  ...
                  <p className="text-muted-foreground">
                    Le degré de saleté et de contamination détermine le niveau de protection nécessaire (EPI), les produits à utiliser, et le temps de désinfection. Un logement très insalubre nécessite un protocole DASRI
                    complet.
                  </p>
                </div>
                ...
                <div className="bg-card rounded-xl p-6 shadow-medium">
                  ...
                  <p className="text-muted-foreground">Une intervention en urgence (sous 24h) ou le week-end peut entraîner un surcoût de 15-25%. Planifier l'intervention permet d'optimiser les coûts.</p>
                </div>
              </div>
            </section>
            ...
            <section id="grille-tarifaire" className="mb-16">
              <h2 className="text-3xl font-bold text-primary mb-6">Grille tarifaire détaillée 2026 (Hérault)</h2>
            ...
            <section id="aides" className="mb-16">
              <h2 className="text-3xl font-bold text-primary mb-6">Aides financières disponibles</h2>
              ...
              <div className="space-y-4 mb-8">
                <div className="bg-success/10 rounded-xl p-6 border-l-4 border-success">
                  <h3 className="text-lg font-bold text-card-foreground mb-2">💰 APA (Allocation Personnalisée d'Autonomie)</h3>
                  <p className="text-sm text-muted-foreground mb-2">Pour les personnes âgées de 60 ans et plus en perte d'autonomie. Peut financer jusqu'à 1 800€/mois selon le niveau de dépendance.</p>
                ...
                <div className="bg-success/10 rounded-xl p-6 border-l-4 border-success">
                  <h3 className="text-lg font-bold text-card-foreground mb-2">💰 PCH (Prestation de Compensation du Handicap)</h3>
                  <p className="text-sm text-muted-foreground mb-2">Pour les personnes en situation de handicap. Peut couvrir les frais d'aménagement et d'entretien du logement.</p>
                  <p className="text-xs text-muted-foreground">
                ...
                <div className="bg-success/10 rounded-xl p-6 border-l-4 border-success">
                  <h3 className="text-lg font-bold text-card-foreground mb-2">💰 Caisses de retraite (CARSAT, MSA, etc.)</h3>
                  <p className="text-sm text-muted-foreground mb-2">Aides pour l'amélioration de l'habitat. Montants variables selon les caisses et situations.</p>
                  <p className="text-xs text-muted-foreground">
                ...
                <div className="bg-success/10 rounded-xl p-6 border-l-4 border-success">
                  <h3 className="text-lg font-bold text-card-foreground mb-2">💰 Action Logement</h3>
                  <p className="text-sm text-muted-foreground mb-2">Pour les salariés du secteur privé. Prêts et subventions pour travaux d'amélioration du logement.</p>
                  <p className="text-xs text-muted-foreground">
                ...
                <div className="bg-success/10 rounded-xl p-6 border-l-4 border-success">
                  <h3 className="text-lg font-bold text-card-foreground mb-2">💰 CCAS (Centre Communal d'Action Sociale)</h3>
                  <p className="text-sm text-muted-foreground mb-2">Aides ponctuelles selon votre situation. Montants variables selon les communes.</p>
                  <p className="text-xs text-muted-foreground">
              ...
              <div className="bg-accent/10 rounded-xl p-6 border-l-4 border-accent">
                <p className="text-sm text-muted-foreground">
                  <strong>💡 Notre accompagnement :</strong> Nous pouvons vous orienter vers les bonnes démarches et vous aider à constituer vos dossiers de demande d'aide. N'hésitez pas à nous en parler lors de
            ...
            <section id="devis" className="mb-16">
              <h2 className="text-3xl font-bold text-primary mb-6">Comment obtenir un devis personnalisé ?</h2>

              <div className="bg-gradient-hero text-primary-foreground rounded-2xl p-8 mb-8">
                <h3 className="text-2xl font-bold mb-4">Devis gratuit sous 12h garanti</h3>
                <p className="mb-6 opacity-95">Notre processus est simple, rapide et totalement confidentiel :</p>
            ...
            <section id="faq" className="mb-16">
              ...
              <div className="space-y-4">
                <div className="bg-card rounded-xl p-6 shadow-medium">
                  <h3 className="font-bold text-lg text-card-foreground mb-2">Le devis est-il vraiment gratuit ?</h3>
                  <p className="text-muted-foreground">
                ...
                <div className="bg-card rounded-xl p-6 shadow-medium">
                  <h3 className="font-bold text-lg text-card-foreground mb-2">Puis-je payer en plusieurs fois ?</h3>
                  <p className="text-muted-foreground">Oui, nous proposons des facilités de paiement adaptées à votre situation. Parlez-en avec nous lors de l'établissement du devis.</p>
                </div>

                <div className="bg-card rounded-xl p-6 shadow-medium">
                  <h3 className="font-bold text-lg text-card-foreground mb-2">Y a-t-il des frais cachés ?</h3>
                  <p className="text-muted-foreground">
                ...
                <div className="bg-card rounded-xl p-6 shadow-medium">
                  <h3 className="font-bold text-lg text-card-foreground mb-2">Le prix varie-t-il selon la ville dans l'Hérault ?</h3>
                  <p className="text-muted-foreground">
                ...
                <div className="bg-card rounded-xl p-6 shadow-medium">
                  <h3 className="font-bold text-lg text-card-foreground mb-2">Combien coûte une intervention d'urgence ?</h3>
                  <p className="text-muted-foreground">
            ...
            <div className="bg-secondary rounded-2xl p-8 text-center">
              <h2 className="text-3xl font-bold text-primary mb-4">Besoin d'un devis personnalisé ?</h2>
              <p className="text-xl text-muted-foreground mb-6">Contactez-nous pour une évaluation gratuite et un devis détaillé sous 12h</p>
              ...
              <p className="text-sm text-muted-foreground mt-4">
                ...
                et{" "}
                <Link to="/zone-intervention-herault" className="text-primary hover:underline">
                  tout l'Hérault
                </Link>
              </p>
            </div>
