...
export function SimulatorHighlight({ children }: SimulatorHighlightProps) {
  return (
    <div className="relative">
      ...
      <div className="absolute -top-4 right-4 md:right-8 bg-accent text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg z-10 animate-fade-in">⚡ Outil Exclusif</div>
      ...
      <div className="border-4 border-accent/20 rounded-3xl p-1 md:p-2 shadow-strong bg-gradient-to-br from-accent/5 to-primary/5">
        <div className="bg-background rounded-2xl p-4 md:p-8">
          ...
          <div className="text-center mb-8 animate-fade-in">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-primary mb-4">Estimez votre coût en 30 secondes</h2>
